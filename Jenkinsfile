pipeline {
 ...
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/anikethulule2000/blue_green_deployment.git'
            }
        }
        stage('Compile') {
            steps {
 ...
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: 'anikettestproject-cluster', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://D9D1E218C9107D5585CB2F2E83C73B65.gr7.us-east-1.eks.amazonaws.com') {
